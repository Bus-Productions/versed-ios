...
- (void) configureWithPoll:(NSMutableDictionary*)poll andColors:(NSArray *)colors
{
    ...
    PNPieChart *pieChart = [[PNPieChart alloc] initWithFrame:CGRectMake(self.bounds.size.width/2 - CHART_WIDTH/2.0, self.bounds.size.height/2 - CHART_HEIGHT/2.0 - 20.0f, CHART_WIDTH, CHART_HEIGHT) items:items];
